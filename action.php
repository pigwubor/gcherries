				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading'>₦ $pro_price.00
								    <button pid='$pro_id' style='float:right;' id='product' class='btn btn-danger btn-xs'><span class='glyphicon glyphicon-shopping-cart'></span>AddToCart</button>
									<button style='float:right;' data-toggle='modal' data-target='#details-1' id='$pro_id' class='btn btn-success btn-xs' onclick='showDetails(this);'>View Detail</button>
								</div>
							</div>
						</div>	
			";
...
if (isset($_POST["Common"])) {
	...
	if (isset($_POST["getCartItem"])) {
		...
		if (mysqli_num_rows($query) > 0) {
			...
			while ($row=mysqli_fetch_array($query)) {
				...
				echo '
					<div class="row">
						...
						<div class="col-md-3"><img class="img-responsive" src="catelogue/product_images/'.$product_image.'" /></div>
			...
			?>
				<a style="float:right;" href="catelogue/cart.php" class="btn btn-danger">Edit&nbsp;&nbsp;<span class="glyphicon glyphicon-edit"></span></a>
			<?php
			exit();
		}
	}
