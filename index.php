...
<nav class="navbar navbar-default navbar-fixed-top" style="background-color: #333;">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#myPage">G-Cherries</a>
    </div>
...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
  ...
  <div id="band" class="container text-center">
    <h2 class="w3-wide">Featured Products</h2>
    ...
    <p class="w3-justify"></p>
        ...
        <img src="images/Fondant cake1.jpg" class="w3-round w3-margin-bottom" alt="Random Name" style="width:80%; max-height:200px">
         <p class="list-price text-danger">List Price: <s>₦15,000</s></p>
        <p class="price">Our Price: ₦10,000</p>
        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#details-1">Details</button>
        <button class="btn" data-toggle="modal" data-target="#details-1">Buy Now</button>
        ...
        <div class="col-sm-3">
        <h3>Special Cake</h3>
        <img src="images/Fondant cake2.jpg" class="w3-round" alt="Random Name" style="width:80%; max-height: 200px">
         <p class="list-price text-danger">List Price: <s>₦15,000</s></p>
        <p class="price">Our Price: ₦10,000</p>
        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#details-1">Details</button>
        <button class="btn" data-toggle="modal" data-target="#details-1">Buy Now</button>
  ...
  <p class="text-center"><em>Drop a note!</em></p>
    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <i class="fa fa-phone" style="width:30px"></i> Phone: +234 7034626807<br>
        <i class="fa fa-mobile" style="width:30px"></i> Phone: +234 8092908916<br>
        <i class="fa fa-envelope" style="width:30px"> </i> Email: cherries5000@gmail.com<br>
      </div>
    <div class="col-md-8">
      <div class="row">
